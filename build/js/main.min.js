...
require("./modules/catalog-toggle");
require("./modules/mobile-menu-toggle");
require("./modules/exclusive-menu-open");
...
},{"./modules/catalog-toggle":2,"./modules/exclusive-menu-open":3,"./modules/form-validate/form":5,"./modules/mobile-menu-toggle":11,"./modules/modals/init-modals":12,"./modules/slider":14,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";

var catalogButton = document.querySelector('.main-header__nav-link--catalog');
var catalogList = document.querySelector('.main-header__catalog');
var catalogArrow = document.querySelector('.main-header__nav-arrow');
if (catalogButton && catalogList && catalogArrow) {
  var setCatalogOpened = function setCatalogOpened(evt) {
    evt.preventDefault();
...
var exclusiveSearchFields = document.querySelectorAll('.search-form__fields');
var searchFormItems = document.querySelectorAll('.search-form__item-name');
var _loop = function _loop(i) {
  searchFormItems[i].addEventListener('click', function () {
    exclusiveSearchFields[i].classList.toggle('search-form__fields--closed');
  });
};
for (var i = 0; i < searchFormItems.length; i++) {
  _loop(i);
}
...
var mobileMenuButton = document.querySelector('.main-header__mobile-button');
var mobileNavigation = document.querySelector('.main-header__navigation');
if (mobileMenuButton && mobileNavigation) {
  var setMobileMenuToggle = function setMobileMenuToggle(evt) {
    evt.preventDefault();
